...
namespace IT_Project.Models
{
    public class TheatrePlayInfo
    {
        ...
        // This Data Annotations are added so the Html.EditorFor helper can display an input of type "datetime-local" properly.
